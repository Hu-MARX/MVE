...
def supp_compute_transf_matrix(pts_src, pts_dst, f_last, image11, image22, dirrr, i):
    if len(pts_src) >= 5:
        print("using local matching 可计算旋转矩阵")
...
def supp_compute_transf_matrix1(f_last, image11, image22, dirrr, i):
    M = matching(image11, image22, dirrr, i, 1)
    print("xianshi", M, type(M))
    M2 = matching(image11, image22, dirrr, i, 2)
    print("xianshi", M2, type(M2))
...
def supp_compute_transf_matrix1_first(image11, image22, dirrr, i):
    M = matching(image11, image22, dirrr, i, 1)
    print("xianshi", M, type(M))
    M2 = matching(image11, image22, dirrr, i, 2)
    print("xianshi", M2, type(M2))
